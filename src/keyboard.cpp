...
std::vector<char> CustomKeyboard::getCommandMappings(const std::vector<RemoteCommand>& commands) {
    ...
    for (size_t i = 0; i < commands.size(); ++i) {
        std::string cleanName = Utils::cleanCommandName(commands[i].functionName);
